...
import {fetchSalesAmountData} from '../api';
          ...
          <Card.Body>
            <Tab.Pane eventKey="month" unmountOnExit>
              <NVD3Chart
                ...
                showControls={false} // 显示控制选项(Stacked | Grouped)
                showLegend={false} // 显示图表的指示
                reduceXTicks={true} // 减少x轴 Lable
                showMaxMin={false}
                datum={[
                  {
                    key: "订单金额",
              ...
              <Card.Title>
                {d3.time.format("%Y年-%m月")(date)}销售订单
              </Card.Title>
            </Tab.Pane>
            <Tab.Pane eventKey="year" unmountOnExit>
              <NVD3Chart
              ...
              <Card.Title>{d3.time.format("%Y年")(date)} 销售订单</Card.Title>
            </Tab.Pane>
          </Card.Body>
        </Tab.Content>
      </Card>
